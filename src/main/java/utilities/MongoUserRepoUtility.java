...
public class MongoUserRepoUtility extends UserRepositoryService {

    private MongoClient mongoClient;
    private DB currentDB;
    private DBCollection currentColection;

    public MongoUserRepoUtility(String database, String collection) {
    ...
    public boolean upsertItem(Object query) {
        ...
        super.upsertUserLog((UnifiedQueryType) query, true);
        return true;
    }
